...
import com.example.mikanattendance.annotation.PassToken;
import com.example.mikanattendance.annotation.UserLoginToken;
import com.example.mikanattendance.entity.User;
import com.example.mikanattendance.service.UserServiceImpl;
    ...
    public boolean preHandle(HttpServletRequest httpServletRequest, HttpServletResponse httpServletResponse, Object object) throws Exception {
        ...
        if (method.isAnnotationPresent(UserLoginToken.class)) {
            ...
            if (userLoginToken.required()) {
                ...
                inUser.setID(Integer.parseInt(userId));
                User user = userService.select(inUser).get(0);
